...
- There were 369,711 votes cast in the election. | ![03.png](/resources/images/03.png)
- The counties were: 
...
- This code accesses the dataset in a specific directory and writes a report to a specific file, but this specific lines of codes can be easily fixed by renaming a directory and file in the code itself.<br/>
